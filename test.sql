...
CREATE OR REPLACE FUNCTION dump_sql_parse_tree(text) returns text AS '/home/sven/diplom/dump_plpgsql_function/dump_plpgsql_function.so', 'dump_sql_parse_tree' LANGUAGE C STRICT;
